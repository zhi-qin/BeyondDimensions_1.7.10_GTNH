...
public class NetHopperMenu extends BDBaseMenu {
     ...
     * 客户端构造函数
     */
    public NetHopperMenu(InventoryPlayer playerInventory) {
     ...
     * 服务端构造函数
     */
    public NetHopperMenu(InventoryPlayer playerInventory, NetHopperBlockEntity be) {
    ...
    protected void writeQuickDataTag(NBTTagCompound tag) {
        ...
        tag.setString("hopper_item_mode", be.hopperItemMode.name());
        tag.setString("hopper_xp_mode", be.hopperXpMode.name());
        tag.setString("hopper_fluid_mode", be.hopperFluidMode.name());
        tag.setString("hopper_nbt_mode", be.hopperNBTMode.name());
        tag.setString("hopper_range_mode", be.hopperRangeMode.name());
    }
